...
Version: 1.0.0
Author: Distance Calculator / www.calculator.io
...
function display_calcio_ci_distance_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_distance_calculator', 'display_calcio_ci_distance_calculator' );